...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('apiInstagram', '0004_remove_postlikes_post_id_remove_postlikes_user_id_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_Third', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserFeeds',
